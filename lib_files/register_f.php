			...
			function checkDateTime($data) 
				...
				if ($err_msg=="") {include('incs/register_img_upload1.inc.php');}
		 		...
		 		if ($err_msg=="")
					{	
						$w1					=1;
						$qinsert 			= "insert into feedback_form1 values(NULL,'$fbid','$store','$firstname','$surname','$image_name','$email','$cell','$passport','$validpass','$validage','$w1','$w2','$w3','$w4','$bdnpass',md5('$pass1'),'0','$acceptedn','$acceptedt','$dob','$gender','$atype',now())";
				...
				else
					{
						$user_details1 = array
							(
								...
								'exp_d'=> array('text'=>'31', 'x'=>303,'y'=>430),
...
<?php 
	...
	//if($data['page']['liked'] == 1){$fan = "yes";}else {$fan = "no";}
			...
			$qfbidpreznt 	= "select fbid from feedback_form1 where fbid=$fbid";
		...
		{ ?>
   			...
   			<div style="font-family:'Arial Black', Gadget, sans-serif">
                ...
                <?php 
					...
					$query = "SELECT * from feedback_form1 where fbid=$fbid;";
					$result  = $db->query($query);
					$user = mysql_fetch_array($result);
...
<div id="user-info"></div>
    ...
    <p>
        Complete the form below to get your WebKings Member Passport and stand a chance to win amazing trips for to South Africa,France,Spain,USA,Canada for Student/Technology Conferences with spending $1000 in spending money.
    </p>
    <!--ol style="list-style: normal;color:#8D8C8C;">
		...
		<form class="form-horizontal" enctype="multipart/form-data" action="index.php?page_ren=stage&stage=stage_1" method="post">
            ...
            <tr>
				<td colspan="2">  
            		<div style="text-align:center; margin-left:auto; margin-right:auto;">      	
     					<?php if ($fan=="no")  {?>  
   							<div class="fb-like" onClick="FB.Event.subscribe('edge.create', function(response) {window.location.reload();} );" data-href="https://www.facebook.com/webkingsafrica" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false"></div>
       					<?php echo $err_msg; ?>
						<?php }?>
        		...
        		<tr class="bdtxt">
                    <td colspan="2" align=right class=bodycopy><div align="left">
                    	<div style="padding-bottom:2px" align="center">
							<span>
                            	<strong><br/>(Fields with an asterisk <span class=formtxt>*</SPAN> are required)</strong>
                            </span>
                        </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="contact-input" name="firstname" value="<?php echo stripslashes($firstname)?>">
                </div>
            </div>


            <div class="control-group">
                <label class="control-label"><span class="formtxt">*</span><span style="color:<?php echo $red_surname?>">Surname:</span>
                </label>
                <div class="controls">
                    <INPUT type="text" class="contact-input"  name="surname" value="<?php echo stripslashes($surname)?>">
                </div>
            </div>
            ...
            <div class="control-group">
                <label class="control-label"><span class="formtxt">*</span><span style="color:<?php echo $red_cell?>">Contact No.:</span></label>
                <div class="controls">
                    <INPUT type="text" class="contact-input"  maxLength=50 name="cell" value="<?php echo stripslashes($cell)?>">                                        </TD>
                </div>
            </div>

            <!--<div class="control-group">
                <label class="control-label"><span style="color:<?php echo $red_validpass?>">Do you have a valid passport you can travel with?:</span></label>
            ...
            <!--div class="control-group">
                ...
                <div class="controls">
                    <label class="radio inline">
                        <input type="radio" name="validage" value="yes" class="form" <?php if($validage=="yes"){echo "checked";}?> >Yes
                    </label>
                    <label class="radio inline">
                        <input type="radio" name="validage" value="no" class="form" <?php if($validage=="no"){echo "checked";}?>  >No
                    </label>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input placeholder="YYYY-MM-DD" name="dob" type="text" class="contact-input" id="datepicker" value="<?php echo $dob ? stripslashes($dob) : $bday;?>" /> <span class="help-inline">(YYYY-MM-DD) eg. (1980-02-02) </span>
                </div>
            </div>
            ...
            <div class="control-group">
                <label class="control-label">
                    <span class="formtxt">*</span><span style="color:<?php echo $red_store?>">Your Picture (Optional) :</span>
            ...
            <div class="control-group">
                <label class="control-label">
                    <span style="color:<?php echo $red_photo?>">Your Picture (Optional) :</span>
...
<div class="controls">
 ...
 <div class="controls">
        ...
        <strong>  I would like to receive Webkings's weekly newsletter for all the latest events, courses, products &amp; competitions.</strong> 
            ...
            <div class="controls">
                <label class="checkbox">I would like to receive DionWired's weekly newsletter for all the latest deals &amp; competitions.
                    <input style="border-style:solid; border-color:#e1226d; border-width:1px;" type="checkbox" id="checkquery" name="acceptedn" <?php if($acceptedn==1){echo "checked";}?>  value=1 /><?php echo $err_msga;?>
                </label>
            </div>
...
<input style="border-style:solid; border-color:#e1226d; border-width:1px;" type="checkbox" id="checkquery" name="acceptedt" <?php if($acceptedt==1){echo "checked";}?>  value=1 /><?php echo $err_msga;?></span>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-facebook">Register For Training.</button>
