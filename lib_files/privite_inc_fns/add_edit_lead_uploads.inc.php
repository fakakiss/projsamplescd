<?php
	if(empty($_FILES['userfile_illus1']['name'])){if($mysql_id>0){$image_name_illus1=$row['illus1'];}else{$image_name_illus1="";}}
	else                  
		{                    						
		...
		if(empty($_FILES['userfile_illus2']['name'])){if($mysql_id>0){$image_name_illus2=$row['illus2'];}else{$image_name_illus2="";}}
      	else                  
	  		{                    						
		...
		if(empty($_FILES['userfile_illus3']['name'])){if($mysql_id>0){$image_name_illus3=$row['illus3'];}else{$image_name_illus3="";}}
      	else                  
	  		{                    						
			...
			if(empty($_FILES['userfile_illus4']['name'])){if($mysql_id > 0){$image_name_illus4=$row['illus4'];}else{$image_name_illus4="";}}
      		else                  
	  		{                    						
...
if(empty($_FILES['userfile_illus5']['name'])){if($mysql_id > 0){$image_name_illus5=$row['illus5'];}else{$image_name_illus5="";}}
...
if(empty($_FILES['userfile_cap_img']['name'])){if($mysql_id > 0){$image_name_cap_img=$row['caption_img'];}else{$image_name_cap_img="";}}
else                  
	  {                    						
...
if(empty($_FILES['userfile_add1']['name'])){if($mysql_id > 0){$image_name_add1=$row['add1'];}else{$image_name_add1="";}}
      else                  
	  {                    						
...
if(empty($_FILES['userfile_add2']['name'])){if($mysql_id > 0){$image_name_add2=$row['add2'];}else{$image_name_add2="";}}
      else                  
	  {                    						
...
if(empty($_FILES['userfile_add3']['name'])){if($mysql_id > 0){$image_name_add3=$row['add3'];}else{$image_name_add3="";}}
      else                  
	  {                    						
...
if(empty($_FILES['userfile_add4']['name'])){if($mysql_id > 0){$image_name_add4=$row['add4'];}else{$image_name_add4="";}}
      else                  
	  {                    						
...
if(empty($_FILES['userfile_add5']['name'])){if($mysql_id > 0){$image_name_add5=$row['add5'];}else{$image_name_add5="";}}
      else                  
	  {                    						
...
if(empty($_FILES['userfile_doc']['name'])){if($mysql_id > 0){$doc_name_doc=$row['doc'];}else {$doc_name_doc ="";}}
      else                  
	  {                    						
...
if(empty($_FILES['userfile_vid']['name'])){if($mysql_id > 0){$vid_name_vid=$row['video'];}else {$vid_name_vid ="";}}
      else                  
	  {                    						
...
if(empty($_FILES['userfile_zip']['name'])){if($mysql_id > 0){$zip_name_zip=$row['zip'];}else {$zip_name_zip="";}}	
      else                  
	  {                    						
...
if(empty($_FILES['userfile']['name'])){if($mysql_id > 0){$image_name=$row['img'];}else {$image_name="";}}
      else                  
	  {                    						
...
if(empty($_FILES['userfile1']['name'])){if($mysql_id > 0){$image_name1=$row['img1'];}else{$image_name1="";}}	   
      else                  
	  {                    						
...
if(empty($_FILES['userfile2']['name'])){if($mysql_id > 0){$image_name2=$row['img2'];}else {$image_name2="";}}
      else                  
	  {                    						
...
if(empty($_FILES['userfile3']['name'])){if($mysql_id > 0){$image_name3=$row['img3'];}else {$image_name3="";}}
      else                  
	  {                    						
...
if(empty($_FILES['userfile4']['name'])){if($mysql_id > 0){$image_name4=$row['img4'];}else {$image_name4="";}}	   
      else                  
	  {                    						
...
if(empty($_FILES['userfile5']['name'])){if($mysql_id > 0){$image_name5=$row['img5'];}else {$image_name5="";}}
      else                  
	  {                    						
