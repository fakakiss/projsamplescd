<div style=" padding-left:20px">
                    ...
                    <div style="font-size:18px; font-weight:bold; color:#0C0 ;padding-bottom:10px">
                        
                        <?php echo $row_leads_details['img5link']?>
                    </div> 
                    
                     <div style="font-size:12px; font-weight:bold; color: #000 ;padding-bottom:10px">
                    ...
                    <div style="font-size:12px; font-weight:bold; color:#0C0 ;padding-bottom:10px">
                        ...
                        <?php if ($row_leads_details['capt4']==1) 		{echo "CCTV & Related"."&nbsp;&nbsp;";}?>
                        <?php if ($row_leads_details['caption5']==1) 	{echo "PABX & Related"."&nbsp;&nbsp;";}?> 
                        <?php if ($row_leads_details['img3link']==1) 	{echo "Copiers & Related"."&nbsp;&nbsp;";}?>
                        <?php if ($row_leads_details['img4link']==1) 	{echo "IT & Related"."&nbsp;&nbsp;";}?>
                    </div>
