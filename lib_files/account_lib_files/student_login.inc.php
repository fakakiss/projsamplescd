<?php if(!($log == md5("YES"))){?>
                                ...
                                <p style="font-size: 12px;" align="center"><b>Student Login</b></p>
									<form action="lib_files/account_lib_files/verify.php" method="post" style="margin:0px">
										<table border="0" cellspacing="0" cellpadding="0" class="bot" style="margin:0px">
											...
											<tr><td colspan="2"><span class="bot" style="margin-left:20px;margin-bottom:0px;"><a href="index.php?page_ren=22"><img src="images/e_punct_b.gif" width="5" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<b style="color:#FF0000">Member Sign Up !</b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php?page_ren=23"><img src="images/e_punct_b.gif" width="5" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<b>Lost Password</b></a></span></td></tr>
										</table>										
									</form>
								</div>
