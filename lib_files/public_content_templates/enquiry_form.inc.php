...
<?php if(!($thanks=="thanks")){?>
 		...
 		<?php if(!empty($err_msg)){?>
            ...
            <div style="font-family:Verdana, Geneva, sans-serif; font-weight:normal; font-size:10px">
...
<table border="0">
                        ...
                        <table border="0">
                          ...
                          <tr>
                                <td><label for="pabx"><strong>PABX</strong></label></td>
                                <td><input type="checkbox" id="checkpabx" name="pabx"  value="Yes"  /></td>
                               
                            </tr>
                            <tr>
                                <td><label for="cctv"><strong>CCTV</strong></label></td>
                                <td><input type="checkbox" id="checkcctv" name="cctv"  value="Yes"  tabindex="6"/></td>
                                
                            </tr>
                            
                            <tr>
                             	<td><label for="copiers"><strong>COPIERS</strong></label></td>
