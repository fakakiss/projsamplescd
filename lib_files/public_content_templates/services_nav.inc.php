<div  style="padding-left:0px; padding-bottom:0px; padding-top:0px">

	<ul id="navmenu_v">
    
    	<li><a style="color:#00F">SERVICE CATEGORIES</a></li>

		<?php 
                $q_nav = "select * from pages where showitem=1 and category=38 order by lp asc";
