...
<?php if(!empty($row_main_page['caption']) && empty($row_main_page['caption_img'])){?>
	<div style="font-size:11px; font:Tahoma, Geneva, sans-serif; font-weight:bold" align="left">
...
<?php if(empty($row_main_page['caption1'])) {?><div><?php echo $row_main_page['caption1']?></div> <?php } ?>										
<?php if(!empty($row_main_page['caption2'])) {?><div><?php echo $row_main_page['caption2']?></div> <?php } ?>        
<?php if(!empty($row_main_page['caption3'])) {?><div><?php echo $row_main_page['caption3']?></div> <?php } ?>               
<?php if(!empty($row_main_page['caption4'])) {?><div><?php echo $row_main_page['caption4']?></div> <?php } ?>										
<?php if(!empty($row_main_page['caption5'])) {?><div><?php echo $row_main_page['caption5']?></div> <?php } ?>											
<?php if(!empty($row_main_page['caption6'])) {?><div><?php echo $row_main_page['caption6']?></div> <?php } ?>										
<?php if(!empty($row_main_page['caption7'])) {?><div><?php echo $row_main_page['caption7']?></div> <?php } ?>										
<?php if(!empty($row_main_page['caption8'])) {?><div><?php echo $row_main_page['caption8']?></div> <?php } ?>										
<?php if(!empty($row_main_page['caption9'])) {?><div><?php echo $row_main_page['caption9']?></div> <?php } ?>										
<?php if(!empty($row_main_page['caption10'])){?><div><?php echo $row_main_page['caption10']?></div><?php } ?>
                                                                                                                                                                                                               				    	 
		    <?php if(empty($row_main_page['intro_head'])){?><div style="padding-bottom:10px;font-weight:bold"><?php echo $row_main_page['intro_head']?></div><?php }?>
...
<br><br>
			...
			<?php if(!($text1=="")) { ?>
				...
				<div style="padding-bottom:10px; padding-top:5px; font-family:Verdana; font-size:10px">
                 
                	<?php if(!empty($row_main_page['head1'])) { ?><div style="padding-bottom:10px; font-size:12px"><strong><?php echo $row_main_page['head1']?></strong></div><?php } ?>
                                                                                                       
                    	<?php if(!empty($row_main_page['img1'])&& file_exists("uploads/images/".$row_main_page['img1'])){?>
                        	<table align="<?php echo $row_main_page['pos1']?>">
                            	<tr> 
                                	<td>
										<div style="padding-<?php $reg=$row_main_page['pos1'];if ($reg=="left") {echo "right";} ?>:10px" align="<?php echo $row_main_page['pos1']?>">                                            	
											<?php
                                ...
                                <?php if(!empty($row_main_page['capt1'])){?><tr><td align="center" valign="top" width="<?php echo "$tn_width1";?>"><div style="font-size:9px" align="center"><?php echo $row_main_page['capt1']?></div></td></tr><?php }?>                                                                                                                           
                           	</table>
                     	<?php }?>
				...
				<?php if(!($text2=="")){?>
					<div style="padding-bottom:10px"> 		  
        				<?php if(!empty($row_main_page['head2'])){?><div style="padding-bottom:10px; font-size:12px"><b><?php echo $row_main_page['head2']?></b></div><?php } ?>
			...
			<?php if(($text5=="")){ ?>
				<div style="padding-bottom:10px">   
					<?php if(!empty($row_main_page['head5'])){?><div style="padding-bottom:10px; font-size:12px"><strong><?php echo $row_main_page['head5']?></strong></div><?php }?>                                                                                                                                                                        
						<?php if(!empty($row_main_page['img5']) && file_exists("uploads/images/".$row_main_page['img1'])){?>
