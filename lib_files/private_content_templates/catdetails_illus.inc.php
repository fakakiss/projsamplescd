	    					<?php if(!empty($row['illus1'])){?>
									<div style="padding-left:0px;padding-right:0px;padding-bottom:5px; padding-top:10px">
										<?php if(!empty($row['illus1'])){?>
                    						...
                    						?>	
                    						<img src="../../uploads/images/<?php $row['illus1']?>" width="<?php echo "$tn_width_illus1";?>" height="<?php echo "$tn_height_illus1";?>" class="cms_image_border" > 
										<?php }?>
									</div>
								<?php }?>
								...
								<?php if(!empty($row['illus2'])){?>
									<div style="padding-left:0px;padding-right:0px;padding-bottom:5px">
										<?php if(!empty($row['illus2'])){ ?>
											...
											?>	
											<img src="../../uploads/images/<?php $row['illus2']?>" width="<?php echo "$tn_width_illus2";?>" height="<?php echo "$tn_height_illus2";?>" class="cms_image_border"> 
										<?php }?>
									</div>
								<?php } ?>
								...
								<?php if(!empty($row['illus3'])){?>
									<div style="padding-left:0px;padding-right:0px;padding-bottom:5px">
										<?php if(!empty($row['illus3'])){?>
											...
											?>	
											<img src="../../uploads/images/<?php $row['illus3']?>" width="<?php echo "$tn_width_illus3";?>" height="<?php echo "$tn_height_illus3";?>" class="cms_image_border"> 
										<?php }?>
									</div>
								<?php }?>
								...
								<?php if(!empty($row['illus4'])){?>
									<div style="padding-left:0px;padding-right:0px;padding-bottom:5px">
										<?php if(!empty($row['illus4'])){ ?>
											...
											?>	
											<img src="../../uploads/images/<?php $row['illus4']?>" width="<?php echo "$tn_width_illus4";?>" height="<?php echo "$tn_height_illus4";?>" class="cms_image_border"> 
										<?php }?>
									</div>
								<?php }?>
								...
								<?php if(!empty($row['illus5'])){?>
									<div style="padding-left:0px;padding-right:0px;padding-bottom:5px">
										<?php if(!empty($row['illus5'])){ ?>
											...
											?>	
											<img src="../../uploads/images/<?php $row['illus5']?>" width="<?php echo "$tn_width_illus5";?>" height="<?php echo "$tn_height_illus5";?>" class="cms_image_border">
										<?php }?>
									</div>
								<?php }?>