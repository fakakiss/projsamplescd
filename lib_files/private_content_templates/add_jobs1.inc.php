		...
		<?php if($group3==1){?>
			<div style="padding-bottom:5px">	                       
				<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
	  				...
	  				<?php if($show_cap==1){?><tr><td <?php if($bold_cap==1){?>class="bold"<?php }?> ><?php echo "$cap";?></td><td><input name="caption" type="text"  value="<?php echo stripslashes($caption)?>" maxlength="<?php echo "$maxlength_cap";?>" size="<?php echo "$size_cap";?>" class="form"><span class="error"><?php echo "$caption_help";?></span></td></tr><?php }?>
					...
					<?php if($show_opt_show==1){?>
                    	<tr>
                        	<td <?php if($bold_opt_show==1){?>class="bold"<?php }?> >
								<?php echo "$opt_show";?>
                        	</td>
                            <td>
                                
                                <input type="radio" name="showitem" value="0" class="form" <?php if($showitem==0){echo "checked";}?> onClick="Disab(this.value)">Pending
                             &nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="showitem" value="1" class="form" <?php if($showitem==1){echo "checked";}?> onClick="Disab(this.value)">Completed 
                             &nbsp;&nbsp;&nbsp;&nbsp;
                                
                                <input type="radio" name="showitem" value="2" class="form" <?php if($showitem==2){echo "checked";}?> onClick="Disab(this.value)">Completed & Collected 
                             &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="showitem" value="3" class="form" <?php if($showitem==3){echo "checked";}?> onClick="Disab(this.value)">Cancelled/Refunded 
                             &nbsp;&nbsp;&nbsp;&nbsp;
                                
                                
                    			<span class="error"><?php echo "$opt_show_help";?></span>
                             </td>
                        </tr>
					<?php }?>
					...
					<?php if($show_cat==1){?>
						<tr><td <?php if($bold_cat==1){?>class="bold"<?php }?>><?php echo "$cat";?></td> 							                                              
          					<td>
		  						<?php 
									$q_pagedtls       	= "select * from pagecategories where id='$pgid'";
					...
					<?php }?>
	  				...
	  				<?php if($show_list_position==1){?><tr><td <?php if($bold_list_position==1){?>class="bold"<?php }?> ><?php echo "$list_position";?></td><td><input name="lp" type="text"  value="<?php echo stripslashes($lp)?>" maxlength="<?php echo "$maxlength_list_position";?>" size="<?php echo "$size_list_position";?>" class="form"><span class="error"><?php echo "$list_position_help";?></span></td></tr><?php }?>											  											                                                 		
		...
		<?php if($group5==1){?>
			<div style="padding-bottom:5px">
				<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
					...
					<?php if($show_cap10==1){?> <tr><td <?php if($bold_cap10==1){?>class="bold"<?php }?> ><?php echo "$cap10";?></td><td><input name="caption10" type="text" value="<?php echo date('Y-m-d H:i')?>" maxlength="<?php echo "$maxlength_cap10";?>" size="<?php echo "$size_cap10";?>" class="form"><span class="error"><?php echo "$caption10_help";?></span></td></tr><?php }?>	
                    
                    
                    <?php if($bold_intro_header==1){?> 
                    	<tr>
                        	<td valign="top" <?php if($bold_intro_header==1){?>class="bold"<?php }?> >
								<?php echo "$intro_header";?> <span class="error"><?php echo "$intro_header_help";?></span>
                            </td>
                            <td>
       							...
       							<option value="">Select Tech
               						<?php
		   								...
		   								while($row_tech=mysql_fetch_array($rst_tech))                                             
	           								{
	           									if($intro_head==$row_tech[username]){echo "<option value=\"$row_tech[username]\" selected>$row_tech[username]";}
		   										else {echo "<option value=\"$row_tech[username]\"         >$row_tech[username]";}
											} 
               						?>
						  </select><span class="error"><?php echo "$caption10_help";?></span>
                            </td>
                        </tr>
					<?php }?>
									...
									<div style="padding-left:5px; padding-right:5px"> 
										<table cellspacing="0" cellpadding="0" class="cms_text">
											...
											<?php if($show_imagelink_caption==1){?>
				    							...
				    							<tr><td><input name="imglink" type="text" value="<?php echo stripslashes($imglink)?>" size="<?php echo "$size_imagelink_caption";?>" maxlength="<?php echo "$maxlength_imagelink_caption";?>" class="form"></td></tr> 						                                                       
                    						<?php }?>
										</table>                                                                                        
       	    						</div>
								<?php }?>       						</td>
							...
							<div style="padding-left:5px; padding-right:5px">  
            					<table cellspacing="0" cellpadding="0" class="cms_text">
				                    ...
				                    <?php if($show_imagelink_caption1==1){?>
				    					...
				    					<tr><td><input name="img1link" type="text" value="<?php echo stripslashes($img1link)?>" size="<?php echo "$size_imagelink_caption1";?>" maxlength="<?php echo "$maxlength_imagelink_caption1";?>" class="form"></td></tr> 						                                                       
                    				<?php }?>
        							...
        							<table cellspacing="0" cellpadding="0" class="cms_text">
                                    	...
                                    	<?php }?> 
			   							...
			   							<?php if($show_imagelink_caption2==1){?>
				    						...
				    						<tr><td><input name="img2link" type="text" value="<?php echo stripslashes($img2link)?>" size="<?php echo "$size_imagelink_caption2";?>" maxlength="<?php echo "$maxlength_imagelink_caption2";?>" class="form"></td></tr> 						                                                       
                    					<?php }?>
								...
								<div style="padding-left:5px; padding-right:5px">
                            		...
                            		<table cellspacing="0" cellpadding="0" class="cms_text">
										...
										<?php if($show_imagelink_caption3==1){?>
				    	        			...
				    	        			<tr><td><input name="img3link" type="text" value="<?php echo stripslashes($img3link)?>" size="<?php echo "$size_imagelink_caption3";?>" maxlength="<?php echo "$maxlength_imagelink_caption3";?>" class="form"></td></tr> 						                                                       
                                		<?php }?>
								...
								<div style="padding-left:5px; padding-right:5px"> 
          							<table cellspacing="0" cellpadding="0" class="cms_text">
			        					...
			        					<?php if($show_imagelink_caption4==1){?>
				    						...
				    						<tr><td><input name="img4link" type="text" value="<?php echo stripslashes($img4link)?>" size="<?php echo "$size_imagelink_caption4";?>" maxlength="<?php echo "$maxlength_imagelink_caption4";?>" class="form"></td></tr> 						                                                       
                    					<?php }?>													  													  													  
					            	</table>
                      			</div>
					  		<?php }?>												
	    						...
	    						<div style="padding-left:5px; padding-right:5px"> 
                  					<table cellspacing="0" cellpadding="0" class="cms_text">												  					   
										...
										<?php if($show_imagelink_caption5==1){?>
											<tr><td <?php if($bold_imagelink_caption5==1){?>class="bold"<?php }?>><?php echo "$imagelink_caption5";?> <span class="error"><?php echo "$imagelink_caption5_help";?></span></td></tr>
											<tr><td><input name="img5link" type="text"  value="<?php echo stripslashes($img5link)?>" size="<?php echo "$size_imagelink_caption5";?>" maxlength="<?php echo "$maxlength_imagelink_caption5";?>" class="form"></td></tr> 						                                                       
                                    	<?php }?>
				  					</table>
             					</div>			 
			 				<?php }?>																										
