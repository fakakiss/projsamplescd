		...
		<?php if($group3==1){?>
			<div style="padding-bottom:5px">
			  <table border="0" cellspacing="0" cellpadding="0" class="cms_text">
			    ...
			    <tr>
			      <td <?php if($bold_imagelink_caption5==1){?>class="bold"<?php }?> ><?php echo "$imagelink_caption5";?></td>
			      <td><input name="img5link" type="text" value="<?php echo stripslashes($row['img5link'])?>" size="<?php echo "$size_imagelink_caption5";?>" maxlength="<?php echo "$maxlength_imagelink_caption5";?>" class="form" /></td>
                  <td>
                  		<input type="hidden" value="OK" name="send"><input name="submit" type="submit" value="<?php echo "$submit_bottom_go";?>">
                  		<span class="error"><?php echo "$imagelink_caption_help5";?></span>
                  </td>
		        </tr>
			    <?php }?>
			    <?php if($show_cap==1){?>
