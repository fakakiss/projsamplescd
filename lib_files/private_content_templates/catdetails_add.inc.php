				<div style="padding:5px">
													<?php if(!empty($row['add1'])){ ?>
														...
														?>	
														<img src="../../uploads/images/<?php $row['add1']?>" width="<?php echo "$tn_width_add1";?>" height="<?php echo "$tn_height_add1";?>" class="cms_image_border"> 
													<?php }?>
												</div>
												...
												<div style="padding:5px">
													<?php if(!empty($row['add2'])){ ?>
														...
														?>	
														<img src="../../uploads/images/<?php $row['add2']?>" width="<?php echo "$tn_width_add2";?>" height="<?php echo "$tn_height_add2";?>" class="cms_image_border">
													<?php }?>
												</div>
												...
												<div style="padding:5px">
													<?php if(!empty($row['add3'])){ ?>
														...
														?>	
														<img src="../../uploads/images/<?php $row['add3']?>" width="<?php echo "$tn_width_add3";?>" height="<?php echo "$tn_height_add3";?>" class="cms_image_border"> 
													<?php }?>
												</div>
												...
												<?php if(!empty($row['add4'])){?>
													<div style="padding:5px">									 
		   												<?php if(!empty($row['add4'])){ ?>
															...
															?>	
															<img src="../../uploads/images/<?php $row['add4']?>" width="<?php echo "$tn_width_add4";?>" height="<?php echo "$tn_height_add4";?>" class="cms_image_border"> 
														<?php }?>		   
													</div>
												<?php }?>
												...
												<?php if(!empty($row['add5'])){ ?>
													<div style="padding:5px">
														...
														?>	
														<img src="../../uploads/images/<?php $row['add5']?>" width="<?php echo "$tn_width_add5";?>" height="<?php echo "$tn_height_add5";?>" class="cms_image_border"> 														
													</div>
												<?php }?>