			...
			<div style="padding-bottom:5px">	                       
				<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
                    ...
                    <?php if($show_imagelink_caption5==1){?>
						<tr>
                       		<td <?php if($bold_imagelink_caption5==1){?>class="bold"<?php }?>><?php echo "$imagelink_caption5";?> <span class="error"><?php echo "$imagelink_caption5_help";?></span></td>
							<td><input name="img5link" type="text"  value="<?php echo stripslashes($img5link)?>" size="<?php echo "$size_imagelink_caption5";?>" maxlength="<?php echo "$maxlength_imagelink_caption5";?>" class="form"></td>
                            <td>
                   ...
                   <?php }?>
	  				...
	  				<?php if($show_cap==1){?>
                    	<tr>
                        	...
                        	<td><input name="caption" type="text"  value="<?php echo stripslashes($caption)?>" maxlength="<?php echo "$maxlength_cap";?>" size="<?php echo "$size_cap";?>" class="form"><span class="error"><?php echo "$caption_help";?></span></td>
                        </tr>
					<?php }?>
	    						...
	    						<div style="padding-left:5px; padding-right:5px"> 
                  					<table cellspacing="0" cellpadding="0" class="cms_text">												  					   
										...
										<?php if($show_image_caption5==1){?>
											...
											<tr><td><input name="capt5" type="text"  value="<?php echo stripslashes($capt5)?>" size="<?php echo "$size_image_caption5";?>" maxlength="<?php echo "$maxlength_image_caption5";?>" class="form"></td></tr>                                   		<?php }?>
