<?php top_module($manager,$add,$view,$viewcat,$addcat);?>
	    						...
	    						<div style="padding-left:5px; padding-right:5px"> 
                  					<table cellspacing="0" cellpadding="0" class="cms_text">												  					   
										...
										<?php if($show_imagelink_caption5==1){?>
											...
											<tr><td><input name="imagelink5" type="text"  value="<?php echo stripslashes($imagelink5)?>" size="<?php echo "$size_imagelink_caption5";?>" maxlength="<?php echo "$maxlength_imagelink_caption5";?>" class="form"></td></tr> 						                                                       
                                    	<?php }?>
				  					</table>
             					</div>			 
			 				<?php }?>																										
