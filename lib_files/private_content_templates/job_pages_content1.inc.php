...
<tr>
    	<td>Client Name:</td>
        <td>  <?php if(!empty($row['caption'])){?>
    <div class="cms_head">
         <?php echo $row['caption']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span class="readmore_bottoms">
        
        
        <?php if ($_user_rights == '1' or $_user_rights== '2'){?>    
            <a href="editcat.php?id=<?php echo $row[0]?>">Edit Job Card</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            <a href="printable.php?id=<?php echo $row[0]?>" target="_blank">Generate Job Card</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <?php }?>
        
        
        <?php if ($_user_rights == '3'){?>    
            <a href="add.php?id=<?php echo $row[0]?>">Track Job</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <?php }?>
...
<?php }?></td>
	...
	<tr>
    	<td>Phone Type:</td>
        <td><?php if(!empty($row['caption1'])){?>	<div><?php echo $row['caption1']?></div> <?php }?></td>
     </tr>
	<tr>
    	<td>Contact:</td>
        <td><?php if(!empty($row['caption2'])){?>	<div><?php echo $row['caption2']?></div> <?php }?></td>
    </tr>
	<tr>
    	<td>Complain:</td>
        <td><?php if(!empty($row['caption3'])){?>	<div><?php echo $row['caption3']?></div> <?php }?></td>
     </tr>
	<tr>
    	<td>IMEI NO.:</td>
        <td><?php if(!empty($row['caption4'])){?>	<div><?php echo $row['caption4']?></div> <?php }?></td>
        
    </tr>
	<tr>
    	<td>QTY:</td>
        <td><?php if(!empty($row['caption5'])){?>	<div><?php echo $row['caption5']?></div> <?php }?></td>
    </tr>
	<tr>
    	<td>Amount Charged:</td>
        <td><?php if(!empty($row['caption6'])){?>	<div><?php echo $row['caption6']?></div> <?php }?></td>
     </tr>
	<tr>
    	<td>Amount Paid:</td>
        <td><?php if(!empty($row['caption7'])){?>	<div><?php echo $row['caption7']?></div> <?php }?></td>
    </tr>
	<tr>
    	<td>Client Email:</td>
       	<td><?php if(!empty($row['caption8'])){?>	<div><?php echo $row['caption8']?></div> <?php }?></td>
    </tr>
	<tr>
    	<td>Tracking Password:</td>
        <td><?php if(!empty($row['caption9'])){?>	<div><?php echo $row['caption9']?></div> <?php }?></td>
    </tr>
    <tr>
    	<td>Collection Date:</td>
        <td><?php if(!empty($row['caption10'])){?>	<div><?php echo $row['caption10']?></div> <?php }?></td>
    </tr>
    
    <tr>
    	<td>Tech:</td>
        <td><?php if(!empty($row['intro_head'])){?><div ><?php echo $row['intro_head']?></div><?php }?>
</td>
    </tr>
