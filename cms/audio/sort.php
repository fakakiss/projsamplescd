<?php
	...
	$q = "select * from images where sort = '$obj' order by name asc";
	...
	?>
		 ...
		 <img src="../../uploads/images/<?php echo $row['name']?>" width="<?php echo "$tn_width";?>" height="<?php echo "$tn_height";?>"  class="cms_image_border">
					...
					<table  class="cms_text"><tr><td width="111">
                            ...
                            <span class="">Image Name:</span></td><td width="269"><span class="cms_event_startdate"> 
...
?>
            <tr> 
              <td align="center" class="">No Images 
