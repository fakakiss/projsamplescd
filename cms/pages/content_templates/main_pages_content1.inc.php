<?php if(!empty($row['caption'])){?>
    ...
    <div class="cms_head">
        ...
        <div class="readmore_bottoms">
            ...
            <a href="editcat.php?mpid=<?php echo $row[0]?>"><?php echo $edit_main ?></a>
            
            <span style="font-size:9px; font-weight:normal"><?php echo $row['lp']?></span>
            
            <span style="font-size:15px"><?php echo $row['caption']?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             
            <a href="add.php?mpid=<?php echo $row[0]?>"><?php echo $add_sub ?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            
            <a href="addlisting.php?mpid=<?php echo $row[0]?>&spid=0"><?php echo $add_listing ?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                       
            <?php if(($row['showitem'])==0){?><a href="delete.php?mpid=<?php echo $row[0]?>">Delete</a><?php }?>
...
<?php if(!empty($row['intro_head'])){?>
	<br>
	<div style="padding-bottom:10px;font-weight:normal; font-size:9px"><?php echo $row['intro_head']?></div>
<?php }?>


<!--Meta Content Description -->
<?php if(!empty($row['intro'])){?>
	<div style="font-weight:normal; font-size:9px; font-style:italic" ><?php echo $row['intro']?></div>
	<br><br>
<?php }?>


<div style="font-size:14px"><strong><?php echo $row['caption1']?></strong></div>
...
<?php if(!empty($row['caption_img']) & file_exists("../../uploads/images/".$row['caption_img'])){?>
	...
	<div style="padding:10px">
    	<img src="../../uploads/images/<?php echo $row['caption_img']?>" width="<?php echo "$tn_width1i";?>" height="<?php echo "$tn_height1i";?>" class="cms_image_border">
    </div>
