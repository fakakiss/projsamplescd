...
<form enctype="multipart/form-data" action="<?php echo $PHP_SELF."?mpid=".$mpid."&spid=".$spid;?>" method="post">
			...
			<div style="padding-bottom:5px">	                       
				<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
                  ...
                  <tr>
                      ...
                      <td valign="top"><select name="subcategory" class="form" style="width:<?php echo "$cat_width";?> ">
