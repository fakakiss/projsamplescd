				...
				<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
	  				...
	  				<?php if($show_cap==1){?>
                    	<tr>
                        	...
                        	<td><input name="caption" type="text"  value="<?php echo stripslashes($caption)?>" maxlength="<?php echo "$maxlength_cap";?>" size="<?php echo "$size_cap";?>" class="form"><span class="error"><input type="hidden" value="OK" name="send"><input name="submit" type="submit" value="<?php echo "$submit_bottom_go";?>"><?php echo "$caption_help";?></span></td>
                        </tr>
					<?php }?>
	    						...
	    						<div style="padding-left:5px; padding-right:5px"> 
                  					<table cellspacing="0" cellpadding="0" class="cms_text">												  					   
										...
										<?php if($show_image_caption5==1){?>
                                            ...
                                            <tr>
                                            <td>
                                            <input name="img5link" type="text"  value="<?php echo stripslashes($img5link)?>" size="<?php echo "$size_imagelink_caption5";?>" maxlength="<?php echo "$maxlength_imagelink_caption5";?>" class="form"></td>
                                            </tr>  
