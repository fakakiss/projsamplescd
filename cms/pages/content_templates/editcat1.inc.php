<?php top_module($manager,$add,$view,$viewcat,$addcat,$_user_rights,$_sess_username);?>
	...
	<?php if(empty($err_msg)){?>
    	<div style="padding-bottom:10px;padding-top:0px; color:#FF0000" class="cms_text">
        	NB. All Fields in bold font are required.
        </div>
	<?php }?>
    
									
<form enctype="multipart/form-data" action="<?php echo $the_page."?mpid=".$mpid;?>" method="post">
				...
				<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
                    ...
                    <?php if($show_itemdatedate==1){?>                         
						<tr> 
                            ...
                            <input type="text" name="date" value="<?php echo stripslashes($row['date'])?>" maxlength="<?php echo "$maxlength_itemdate";?>" size="<?php echo "$size_itemdate";?>" class="form">
			...
			<div style="padding-bottom:5px">
			  <table border="0" cellspacing="0" cellpadding="0" class="cms_text">
			    ...
			    <tr>
			      ...
			      <td valign="top"><input name="caption" type="text"  value="<?php echo stripslashes($row['caption'])?>" maxlength="<?php echo "$maxlength_cap";?>" size="<?php echo "$size_cap";?>" class="form" />
                  <input type="hidden" value="OK" name="send"><input name="submit" type="submit" value="<?php echo "$submit_bottom_go";?>"></td>
			    ...
			    <tr>
			      ...
			      <td>
				  	...
				  	<?php if($show_cap_img_select==0){?>
			        	<input name="userfile_cap_img" type="file" size="<?php echo "$capimage_size";?>" class="form" />
			        <?php }?>
			      ...
			      <td><?php if(!empty($row['caption_img'])){ ?>
			        <?php if( !empty($row['caption_img']) && !( file_exists("../../uploads/images/".$row['caption_img'])) ){?>
			        <img src="../cms_images/image_error.jpg" class="cms_image_border" /><a href="<?php echo $the_page;?>?id=<?php echo $row[0]?>&&del=caption_img "><img src="../cms_images/del.jpg" border="0" /></a>
			        <?php }else if( !empty($row['caption_img']) && ( file_exists("../../uploads/images/".$row['caption_img'])) ){?>
			        <?php
 		if (!$max_width_caption_img ) $max_width_caption_img   = 200; 
 		if (!$max_height_caption_img )$max_height_caption_img  =  150;
	...
	?>
			    ...
			    <?php if($show_opt_show==1){?>
			    	<tr>
			      		<td valign="top" <?php if($bold_opt_show==1){?>class="bold"<?php }?>><?php echo "$opt_show";?></td>
			      			...
			      			<td valign="top"><input name="showitem" type="checkbox" value="1" <?php if (($row['showitem'])==1) {echo "checked";} ?> /></td>
			    ...
			    <tr>
			      ...
			      <td valign="top"><select name="category" class="form" style="width:<?php echo "$cat_width";?> ">
...
while($rowcat = mysql_fetch_array($rstcat))
{
	...
	{
		echo "<OPTION VALUE=\"$rowcat[0]\" SELECTED>$rowcat[img5link]";
	}
	else
	{
		echo "<OPTION VALUE=\"$rowcat[0]\">$rowcat[img5link]";
	}
}
?>
		            </option>
			        </select></td>
			      <td><span class="error"><?php echo "$cat_help";?></span></td>
		        </tr>
			    <?php }?>
			    <?php if($show_list_position==1){?>
			    <tr>
			      <td valign="top" <?php if($bold_list_position==1){?>class="bold"<?php }?> ><?php echo "$list_position";?></td>
			      <td valign="top"><input name="lp" type="text"  value="<?php echo stripslashes($row['lp'])?>" maxlength="<?php echo "$maxlength_list_position";?>" size="<?php echo "$size_list_position";?>" class="form" /></td>
			      <td><div class="error"><?php echo "$list_position_help";?></div></td>
		        </tr>
			    <?php }?>
		      </table>
			</div>			
...
<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
	...
	<div style="padding-left:5px; padding-right:5px"> 
													  ...
													  <tr> 
                                                          <td width="100">
														      ...
														      <?php if(!empty($row['img1']) && file_exists("../../uploads/images/".$row['img1'])){ ?>
 ...
 if (($width  <= $max_width) && ($height <= $max_height)) {
	...
	?>	
 <img src="../../uploads/images/<?php echo $row['img1']?>" width="<?php echo "$tn_width";?>" height="<?php echo "$tn_height";?>" class="cms_image_border"> <a href="<?php echo $the_page;?>?mpid=<?php echo $row[0]?>&&del=img1"><img src="../cms_images/del.jpg" border="0"></a>
	...
	<?php }?>
					...
					?>
														...
														<tr><td <?php if($bold_imagelink_caption==1){?>class="bold"<?php }?> ><?php echo "$imagelink_caption1";?> <span class="error"><?php echo "$imagelink_caption_help";?></span></td></tr>
...
<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
 ...
 if (($width  <= $max_width) && ($height <= $max_height)) {
	...
	?>	
 <img src="../../uploads/images/<?php echo $row['img2']?>" width="<?php echo "$tn_width";?>" height="<?php echo "$tn_height";?>" class="cms_image_border"> <a href="<?php echo $the_page;?>?mpid=<?php echo $row[0]?>&&del=img2"><img src="../cms_images/del.jpg" border="0"></a>
...
<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
 ...
 if (($width  <= $max_width) && ($height <= $max_height)) {
	...
	?>	
 <img src="../../uploads/images/<?php echo $row['img3']?>" width="<?php echo "$tn_width";?>" height="<?php echo "$tn_height";?>" class="cms_image_border"> <a href="<?php echo $the_page;?>?mpid=<?php echo $row[0]?>&&del=img3"><img src="../cms_images/del.jpg" border="0"></a>
...
<div  style="padding-bottom:10 "></div>
 ...
 if (($width  <= $max_width) && ($height <= $max_height)) {
	...
	?>	
 <img src="../../uploads/images/<?php echo $row['img4']?>" width="<?php echo "$tn_width";?>" height="<?php echo "$tn_height";?>" class="cms_image_border"> <a href="<?php echo $the_page;?>?mpid=<?php echo $row[0]?>&&del=img4"><img src="../cms_images/del.jpg" border="0"></a>
...
<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
 ...
 if (($width  <= $max_width) && ($height <= $max_height)) {
	...
	?>	
 <img src="../../uploads/images/<?php echo $row['img5']?>" width="<?php echo "$tn_width";?>" height="<?php echo "$tn_height";?>" class="cms_image_border"> <a href="<?php echo $the_page;?>?mpid=<?php echo $row[0]?>&&del=img5"><img src="../cms_images/del.jpg" border="0"></a>
    ...
    <tr><td>
     <?php echo "$imagelink_caption5";?> <span class="error"><?php echo "$imagelink_caption5_help";?></span>
    </td></tr>
    
    <tr><td>
    <input name="img5link" type="text" value="<?php echo stripslashes($row['img5link'])?>" size="<?php echo "$size_imagelink_caption5";?>" maxlength="<?php echo "$maxlength_imagelink_caption5";?>" class="form" />
    </td></tr>                                                    
    ...
    <td valign="top" bgcolor="#99FF00">
		...
		<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
			...
			<tr><td colspan="3" valign="top" <?php if($bold_intro_header==1){?>class="bold"<?php }?> ><?php echo "$intro_header";?> <span class="error"><?php echo "$intro_header_help";?></span></td></tr>					
  			<tr><td colspan="3"><input name="intro_head" type="text"  value="<?php echo stripslashes($row['intro_head'])?>" size="<?php echo "$size_header_intro_head";?>" maxlength="<?php echo "$maxlength_header_intro_head";?>" class="form"></td></tr>
							...
							<tr> 
                    			<td width="100">
									...
									<?php if(!empty($row['img'])){ ?>
										...
										?>	
										<img src="../../uploads/images/<?php echo $row['img']?>" width="<?php echo "$tn_width";?>" height="<?php echo "$tn_height";?>" class="cms_image_border"> <a href="<?php echo $the_page;?>?mpid=<?php echo $row[0]?>&&del=img"><img src="../cms_images/del.jpg" border="0"></a>
				...
				<table border="0" cellspacing="0" cellpadding="0" class="cms_text">  			  					
	    				...
	    				<tr>
		    				...
		    				<td>      
            					<?php if(!empty($row['illus1']) && file_exists("../../uploads/images/".$row['illus1']) ){ ?>
                    				...
                    				?>	
                    				<img src="../../uploads/images/<?php echo $row['illus1']?>" width="<?php echo "$tn_width_illus1";?>" height="<?php echo "$tn_height_illus1";?>" class="cms_image_border" > <a href="edit.php?mpid=<?php echo $row[0]?>&&del=illus1"><img src="../cms_images/del.jpg" border="0"></a>	
								<?php }?>
	                ...
	                <?php if($show_illus2==1){?>
	  					<tr>
		   					...
		   					<td>
								...
								<?php if($show_illus2_select==0){?>
                                	<input name="userfile_illus2" type="file" size="<?php echo "$illus_size";?>" class="form">
								<?php }?>						
		   					...
		   					<td>		   
           						<?php if(!empty($row['illus2'])  && file_exists("../../uploads/images/".$row['illus2']) ){ ?>
                                    ...
                                    <a href="edit.php?mpid=<?php echo $row[0]?>&&del=illus2">
                                    	<img src="../cms_images/del.jpg" border="0">
                                    </a>
	  					...
	  					<tr>
		   					...
		   					<td>
		   						<?php if(!empty($row['illus3']) && file_exists("../../uploads/images/".$row['illus3']) ){ ?>
									...
									?>	
									<img src="../../uploads/images/<?php echo $row['illus3']?>" width="<?php echo "$tn_width_illus3";?>" height="<?php echo "$tn_height_illus3";?>" class="cms_image_border"> <a href="edit.php?mpid=<?php echo $row[0]?>&&del=illus3"><img src="../cms_images/del.jpg" border="0"></a>
								<?php }?>
	  					...
	  					<tr>
		   					...
		   					<td>   
		   						<?php if(!empty($row['illus4']) && file_exists("../../uploads/images/".$row['illus4'])  ){ ?>
									...
									?>	
									<img src="../../uploads/images/<?php echo $row['illus4']?>" width="<?php echo "$tn_width_illus4";?>" height="<?php echo "$tn_height_illus4";?>" class="cms_image_border"> <a href="edit.php?mpid=<?php echo $row[0]?>&&del=illus4"><img src="../cms_images/del.jpg" border="0"></a>
								<?php }?>		   
	            	...
	            	<?php if($show_illus5==1){?>  
		   			...
		   			<td>
						...
						?>	
						<img src="../../uploads/images/<?php echo $row['illus5']?>" width="<?php echo "$tn_width_illus5";?>" height="<?php echo "$tn_height_illus5";?>" class="cms_image_border"> <a href="edit.php?mpid=<?php echo $row[0]?>&&del=illus5"><img src="../cms_images/del.jpg" border="0"></a>
						<?php }?>
...
<table border="0" cellspacing="0" cellpadding="0" class="cms_text">
	...
	?>	
	<img src="../../uploads/images/<?php echo $row['add1']?>" width="<?php echo "$tn_width_add1";?>" height="<?php echo "$tn_height_add1";?>" class="cms_image_border"> <a href="edit.php?mpid=<?php echo $row[0]?>&&del=add1"><img src="../cms_images/del.jpg" border="0"></a>
<?php }?>
	...
	?>	
	<img src="../../uploads/images/<?php echo $row['add2']?>" width="<?php echo "$tn_width_add2";?>" height="<?php echo "$tn_height_add2";?>" class="cms_image_border"> <a href="edit.php?mpid=<?php echo $row[0]?>&&del=add2"><img src="../cms_images/del.jpg" border="0"></a>
<?php }?>
	...
	?>	
	<img src="../../uploads/images/<?php echo $row['add3']?>" width="<?php echo "$tn_width_add3";?>" height="<?php echo "$tn_height_add3";?>" class="cms_image_border"> <a href="edit.php?mpid=<?php echo $row[0]?>&&del=add3"><img src="../cms_images/del.jpg" border="0"></a>
<?php }?>
	...
	?>	
	<img src="../../uploads/images/<?php echo $row['add4']?>" width="<?php echo "$tn_width_add4";?>" height="<?php echo "$tn_height_add4";?>" class="cms_image_border"> <a href="edit.php?mpid=<?php echo $row[0]?>&&del=add4"><img src="../cms_images/del.jpg" border="0"></a>
<?php }?>
	...
	?>	
	<img src="../../uploads/images/<?php echo $row['add5']?>" width="<?php echo "$tn_width_add5";?>" height="<?php echo "$tn_height_add5";?>" class="cms_image_border"> <a href="edit.php?mpid=<?php echo $row[0]?>&&del=add5"><img src="../cms_images/del.jpg" border="0"></a>
<?php }?>
