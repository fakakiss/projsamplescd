<?php
	...
	$intro_header                        = "Page Description Data:";
	$intro_header_help                   = "";
	$maxlength_header_intro_head         = "255"; 
	$size_header_intro_head              = "40";
	$show_intro_header                   = "1";
	$bold_intro_header                   = "0"; 
		
	$introduction                        = "Meta Data:";
	$introduction_cols                   = "43"; 
	$introduction_rows                   = "11";
	$introduction_help                   = "";
	$show_introduction                   = "1";
	$bold_introduction                   = "0"; 
	...
	$image_caption4_help                 = "";
	$image_caption4_size                 = "Image Caption 4:";
	...
	$maxlength_imagelink_caption5        = "255"; 
