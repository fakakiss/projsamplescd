                                         ...
                                         <tr>
										   ...
										   <td valign="top" align="right">
											 ...
											 <?php if (($row_pages['showitem'])==1) {echo "<span class=on>On</span>";} else {echo "<span class=off>Off</span>";}?>&nbsp;
                                              ...
                                              <a href="delete.php?id=<?php echo $row_pages[0]?>">Delete</a> 
                                           </div></td>
									     </tr>
                                         ...
                                         <tr>
										   ...
										   <td valign="top" align="right">
											 ...
											 <?php if (($row_listing['showitem'])==1) {echo "<span class=on>On</span>";} else {echo "<span class=off>Off</span>";}?>&nbsp;
											  ...
											  <a href="javascript:NewWindow('addlistinggallaryimage.php?id=<?php echo $row_listing[0]?>','','700','700','center','front')">Add Gallary Image</a>&nbsp;
											  <a href="javascript:NewWindow('addlistinggallaryvideo.php?id=<?php echo $row_listing[0]?>','','700','700','center','front')">Add Gallary Video</a>&nbsp;
											  <a href="javascript:NewWindow('addlistinggallaryaudio.php?id=<?php echo $row_listing[0]?>','','700','700','center','front')">Add Gallary Audio</a>&nbsp;
                                           </div></td>
									     </tr>
