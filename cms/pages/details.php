<?php
	...
	$q = "select * from $system_table where id='$mysql_id'";
...
<?php }?>
						...
						<?php if(!empty($row['caption_img'])){?><div><img src="../../uploads/images/<?php echo $row['caption_img']?>" width=200 height=30 class="cms_image_border"></div><?php } ?>                                          									  
                    	...
                    	<div class="readmore_bottoms" style="padding-top:5px"><a href="edit.php?id=<?php echo $row[0]?>">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="delete.php?id=<?php echo $row[0]?>">Delete</a></div> 
