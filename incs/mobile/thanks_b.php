...
Please see all the <a href="index_b.php">Stages</a> that are currently open and increase your chance of winning.
            </p>
        </div>
    ...
    <a href="index_b.php" class="button block">Home</a>
<?php include('flow_b.php')?>		
</div>