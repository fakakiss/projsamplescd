...
font-weight: bold;" href="index_m.php?page_ren=s2">Enter to get your Blue Carpet Boarding Pass</a></div>
<?php }?>
<?php if($week3=="0"){?>
...
color: #FFFFFF;padding:10px;
text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.35);
font-weight: bold;" href="index_m.php?page_ren=s3">Share with friends via Email</a></div>
<?php }?>
<?php if($week4=="0"){?>
...
color: #FFFFFF;padding:10px;
text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.35);
font-weight: bold;" href="index_m.php?page_ren=s4">Share with friends via SMS</a></div>
<?php }?>
<?php } ?>