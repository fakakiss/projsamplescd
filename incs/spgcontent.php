...
<?php if(!($introx=="")){?>
	<div>
		<?php if(!empty($row_main_page['img']) && file_exists($row_main_page['img']) ){?>
			...
			<?php }else { ?> 
              ...
              <?php } ?> 
					...
					<?php if( ($pagecatcode!=36) && ($pagecatcode!=53) && ($pagecatcode!=101)){ ?>
						...
						<?php if(!empty($row_main_page['caption_img']) && file_exists($row_main_page['caption_img']) ){?>
      ...
      <?php }?>      
						...
						if (!empty($text15_logs))
							{
								...
								mysql_query($q_logs) or die(mysql_error());
							}												
					}
				...
				if( isset($_REQUEST["send"] ) && ( ($_REQUEST["send"]) =='OK') && ($pagecatcode==78) && ($s1pay_id>0) )
					{
						...
						mysql_query($q_payment) or die(mysql_error());
					}
			...
			<?php if($pagecatcode==78)  {?> 
                ...
                <?php 
					...
					if 		($location_v =="") 			{$location_v ="Ghana";}
					elseif	($location_v =="All")  		{$location_v ="All";}
            	...
            	<a href="index.php?page_ren=78&loca=All"  <?php if($location_v=="All"){echo " style=\"font-weight:bold\"";}?>>All</a> |
            	...
            	<?php 				
					...
					register_members(1,$location_v,$fbid,$screen,$showall);					
				?>              
			<?php }?>
			...
			<?php if($pagecatcode==86)  {?>
            	...
            	<a href="index.php?page_ren=86&loca=All"  <?php if($location_v=="All"){echo " style=\"font-weight:bold\"";}?>>All</a> |             
            	...
            	<?php 				
					...
					stage2_register_members(1,$location_v,$fbid,$screen);				
				?>                
			<?php }?>
			...
			<?php if($pagecatcode==87)  {?>
            	...
            	<a href="index.php?page_ren=87&loca=All" <?php if($location_v=="All"){echo " style=\"font-weight:bold\"";}?>>All</a> |              
            	...
            	<?php 				
					//$location_v  =trim($_REQUEST["loca"]);  
					offered_register_members(1,$location_v,$fbid);				
				?>                
			<?php }?>
            ...
            <?php if($pagecatcode==80)  {?>
            	...
            	<a href="index.php?page_ren=80&loca=All" <?php if($location_v=="All"){echo " style=\"font-weight:bold\"";}?>>All</a> |                         
            	...
            	<?php 				
					//$location_v  =trim($_REQUEST["loca"]);  
					paid_regen_register_members(1,$location_v,$fbid);				
				?>                
			<?php }?>
            ...
            <?php if($pagecatcode==88)  {?>
            	...
            	<a href="index.php?page_ren=88&loca=All" <?php if($location_v=="All"){echo " style=\"font-weight:bold\"";}?>>All</a> |                         
            	...
            	<?php 				
					//$location_v  =trim($_REQUEST["loca"]);  
					paid_aleast_1intalmt_members(1,$location_v,$fbid);				
				?>                
			<?php }?>
            ...
            <?php if($pagecatcode==89)  {?>
            	...
            	<a href="index.php?page_ren=89&loca=All" <?php if($location_v=="All"){echo " style=\"font-weight:bold\"";}?>>All</a> |                         
            	...
            	<?php 				
					//$location_v  =trim($_REQUEST["loca"]);  
					showed_up_register_members(1,$location_v,$fbid);				
				?>                
			<?php }?>
            ...
            <?php if($pagecatcode==77)  {?> 
                ...
                <a href="index.php?page_ren=77&type=All" <?php if($type_v=="All"){echo " style=\"font-weight:bold\"";}?>>All</a> |        
            	<a href="index.php?page_ren=77&type=DPL" <?php if($type_v=="DPL"){echo " style=\"font-weight:bold\"";}?>>Project 2000</a> |
                <a href="index.php?page_ren=77&type=TOT" <?php if($type_v=="TOT"){echo " style=\"font-weight:bold\"";}?>>AutoCad</a> | 
               	<a href="index.php?page_ren=77&type=TOT" <?php if($type_v=="TOT"){echo " style=\"font-weight:bold\"";}?>>TOT</a> |
                <a href="index.php?page_ren=77&type=K4C" <?php if($type_v=="K4C"){echo " style=\"font-weight:bold\"";}?>>Kids4Coding</a> |
                <a href="index.php?page_ren=77&type=TOT" <?php if($type_v=="TOT"){echo " style=\"font-weight:bold\"";}?>>Telesales</a> |
                <a href="index.php?page_ren=77&type=RSC" <?php if($type_v=="RSC"){echo " style=\"font-weight:bold\"";}?>>Resource</a> |
                <a href="index.php?page_ren=77&type=WUC" <?php if($type_v=="WUC"){echo " style=\"font-weight:bold\"";}?>>WebKings University</a> |
                <a href="index.php?page_ren=77&type=SPS" <?php if($type_v=="SPS"){echo " style=\"font-weight:bold\"";}?>>Sponsors</a> |
                <a href="index.php?page_ren=77&type=PTS" <?php if($type_v=="PTS"){echo " style=\"font-weight:bold\"";}?>>Partners</a>
                <br><br> 
                
               
                  
                <a href="index.php?page_ren=77&loca=All" <?php if($location_v=="All"){echo " style=\"font-weight:bold\"";}?>>All</a> |        
                ...
                <a href="index.php?page_ren=77" <?php if($location_v==""){echo " style=\"font-weight:bold\"";}?>>All</a> |        
            	<a href="index.php?page_ren=77&ccat=Ghana" <?php if($location_v=="Ghana"){echo " style=\"font-weight:bold\"";}?>>In Class</a> | 
               	<a href="index.php?page_ren=77&ccat=SA" <?php if($location_v=="SA"){echo " style=\"font-weight:bold\"";}?>>Online</a>
            	...
            	<?php 				
					//$location_v  =trim($_REQUEST["loca"]);
					all_register_members($location_v,$fbid)				
				?>               
			<?php }?>
                        ...
                        <?php if($pagecatcode==79)  {?>  
                            ...
                            <?php 				
                                //$location_v  =trim($_REQUEST["loca"]);  				
                                register_members(2,$location_v,$fbid);				
                            ?>              
                        <?php }?>
                        ...
                        <?php if($pagecatcode==75)  {?> 
                            ...
                            <?php 				
                                //$location_v  =trim($_REQUEST["loca"]);    				
                                register_members(4,$location_v,$fbid);				 
                             ?>                
                        <?php }?>
                        ...
                        <?php if($pagecatcode==83)  {?> 
                            ...
                            <?php 				
                                //$location_v  =trim($_REQUEST["loca"]);    				
                                register_members(3,$location_v,$fbid);				 
                             ?>                
                        <?php }?>
    					...
    					<?php 
							$no_show = array(52,42,36,78,86,87,80,88,89,77,101,70);
							if(  !(in_array($pagecatcode,$no_show))  ){
							//if( ($pagecatcode!=77) ){
						?>
...
<p>(See our <a href="">privacy policy</a>.)</p>
 ...
 /.block -->
					...
					$no_show = array(52,36,42,78,86,87,80,88,89,77,101,70);
					if(  !(in_array($pagecatcode,$no_show))  ){
