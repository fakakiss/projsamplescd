...
<?php
	...
	$eml4  			=trim($_REQUEST["eml4"]);
	$eml5  			=trim($_REQUEST["eml5"]);
	$eml6  			=trim($_REQUEST["eml6"]);
	$eml7  			=trim($_REQUEST["eml7"]);
	$eml8  			=trim($_REQUEST["eml8"]);
	$eml9  			=trim($_REQUEST["eml9"]);
	$eml10  			=trim($_REQUEST["eml10"]);
	...
	$nam6  			=trim($_REQUEST["nam6"]);
	$nam7  			=trim($_REQUEST["nam7"]);
	$nam8  			=trim($_REQUEST["nam8"]);
	$nam9  			=trim($_REQUEST["nam9"]);
	$nam10  		=trim($_REQUEST["nam10"]);
...
$subject 	= $row_membername['firstname']." ".$row_membername['surname']." invites you to Register for the WebKings Training & Placement Project."; 
...
function get_body($name,$mail,$subject,$fromName)
{
    ...
    include "swift/mail/content.php";
...
<?php if(!($sent_off==1) && !($played_promo>=1)){?>
	...
	<div class="">
    <h1>Stage 3: Share with friends! </h1>
    ...
    <div>
		...
		<form class="form-horizontal" enctype="multipart/form-data" action="index.php?page_ren=stage&stage=stage_3" method="post">
            ...
            <div style="margin-top:15px;" class="alert alert-info">Share with only 3 friends via email and get 5 more entries into the draw!</div>
                    ...
                    <div class="controls" style="margin-left:40px;font:12px/18px Arial,Helvetica,sans-serif;font-weight:bold;margin-bottom:10px;">
                        ...
                        <span class="formtxt">*</span><span style="color:<?php echo $red_eml1?>"> Valid email address</span>
                        <input type="text" class="contact-input" name="eml1" value="<?php echo stripslashes($eml1)?>">
                    </div>
                    ...
                    <div class="controls" style="margin-left:40px;font:12px/18px Arial,Helvetica,sans-serif;font-weight:bold;margin-bottom:10px;">
                        ...
                        <span class="formtxt">*</span><span style="color:<?php echo $red_eml2?>"> Valid email address</span>
                        <input type="text" class="contact-input" name="eml2" value="<?php echo stripslashes($eml2)?>">
                    </div>
                    ...
                    <div class="controls" style="margin-left:40px;font:12px/18px Arial,Helvetica,sans-serif;font-weight:bold;margin-bottom:10px;">
                        ...
                        <span class="formtxt">*</span><span style="color:<?php echo $red_eml3?>"> Valid email address</span>
                        <input type="text" class="contact-input" name="eml3" value="<?php echo stripslashes($eml3)?>">
                    </div>
            ...
            <div class="about-welcome-inner" align="center" style="margin-left:-34px;">
                <label class="checkbox">
					<span class="formtxt"><input style="float:none;border-style:solid; border-color:#e1226d; border-width:1px;margin-right:10px;margin-bottom:4px;" type="checkbox" id="checkquery" name="acceptedt" <?php if($acceptedt==1){echo "checked";}?>  value=1 /><?php echo $err_msga;?>* </span><span style="color:<?php echo $red_acceptedt?>">I have read and understand the <a class="ajax" href="incs/terms.php">Terms &amp; Conditions</a> and <a class="ajax" href="incs/privacy.php">Privacy Policy</a>.</span>
				</label>
            </div>
